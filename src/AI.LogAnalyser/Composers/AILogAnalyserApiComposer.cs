...
namespace AI.LogAnalyser.Composers
{
    public class AILogAnalyserApiComposer : IComposer
    {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("AI.LogAnalyser.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
